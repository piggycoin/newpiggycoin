...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Tue Jul 22 18:15:39 2014
# Project:  newpiggycoin-qt.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake USE_UPNP=- USEIPV6=1 USE_QRCODE=1 -o Makefile newpiggycoin-qt.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_WEBKIT -DQT_GUI -DBOOST_THREAD_USE_LIB -DBOOST_SPIRIT_THREADSAFE -DBOOST_THREAD_PROVIDES_GENERIC_SHARED_MUTEX_ON_WIN -D__NO_SYSTEM_INCLUDES -DUSE_QRCODE -DUSE_IPV6=1 -DHAVE_BUILD_INFO -DLINUX -DQT_NO_DEBUG -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB -DQT_SHARED
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -lqrencode /home/kruug/workspace/newpiggycoin/src/leveldb/libleveldb.a /home/kruug/workspace/newpiggycoin/src/leveldb/libmemenv.a -lrt -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lpthread -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
...
$(TARGET): /home/kruug/workspace/newpiggycoin/src/leveldb/libleveldb.a /home/kruug/workspace/newpiggycoin/build/build.h build/ui_coincontroldialog.h build/ui_sendcoinsdialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_statisticspage.h build/ui_blockbrowser.h build/ui_optionsdialog.h build/ui_chatwindow.h build/ui_qrcodedialog.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: newpiggycoin-qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) USE_UPNP=- USEIPV6=1 USE_QRCODE=1 -o Makefile newpiggycoin-qt.pro
...
/home/kruug/workspace/newpiggycoin/src/leveldb/libleveldb.a: FORCE
	cd /home/kruug/workspace/newpiggycoin/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-fpermissive -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/home/kruug/workspace/newpiggycoin/build/build.h: FORCE
	cd /home/kruug/workspace/newpiggycoin; /bin/sh share/genbuild.sh /home/kruug/workspace/newpiggycoin/build/build.h
