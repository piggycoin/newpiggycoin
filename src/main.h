...
inline int64_t PastDrift(int64_t nTime)   { return nTime - 7 * 60; } // up to 7 minutes from the past (was 20 mins)
inline int64_t FutureDrift(int64_t nTime) { return nTime + 8 * 60; } // up to 8 minutes from the future (was 20 mins)
