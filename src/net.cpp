...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("newpiggycoin-ext-ip");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("newpiggycoin-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "newpiggycoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"seeder.piggy-coin.com", "piggynodes.piggy-coin.com"},
    {"seeder.piggyfacts.com", "piggynodes.piggyfacts.com"},
    {"seeder.blockpunk.com", "piggynodes.blockpunk.com"},
    {"seeder.neurocis.me", "piggynodes.neurocis.me"}
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("newpiggycoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("newpiggycoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("newpiggycoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("newpiggycoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. newpiggycoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("newpiggycoin-start");
