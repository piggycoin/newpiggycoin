    ...
    fCapsLock(false)
{
    ...
    switch(mode)
    {
        ...
        case Unlock: // Ask passphrase
            ...
            ui->passLabel3->hide();
            ui->passEdit3->hide();
            setWindowTitle(tr("Unlock piggybank"));
            break;
        case Decrypt:   // Ask passphrase
            ui->warningLabel->setText(tr("This operation needs your piggybank passphrase to decrypt the piggybank."));
            ui->passLabel2->hide();
            ui->passEdit2->hide();
            ui->passLabel3->hide();
            ui->passEdit3->hide();
            setWindowTitle(tr("Decrypt piggybank"));
            break;
...
void AskPassphraseDialog::accept()
{
    ...
    case Encrypt: {
        ...
        QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm piggybank encryption"),
                 tr("Warning: If you encrypt your piggybank and lose your passphrase, you will <b>LOSE ALL OF YOUR COINS</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your piggybank?"),
            ...
            if(newpass1 == newpass2)
            {
                if(model->setWalletEncrypted(true, newpass1))
                {
                    QMessageBox::warning(this, tr("Piggybank encrypted"),
                                         "<qt>" + 
                                         tr("newpiggycoin will close now to finish the encryption process. "
                                         "Remember that encrypting your piggybank cannot fully protect "
                                         "your coins from being stolen by malware infecting your computer.") + 
                                         "<br><br><b>" + 
                                         tr("IMPORTANT: Any previous backups you have made of your piggybank file "
                                         "should be replaced with the newly generated, encrypted piggybank file. "
                                         "For security reasons, previous backups of the unencrypted piggybank file "
                                         "will become useless as soon as you start using the new, encrypted piggybank.") + 
                                         "</b></qt>");
                    QApplication::quit();
                }
                else
