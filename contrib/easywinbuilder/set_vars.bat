...
@set BOOSTSUFFIX=-mgw46-mt-s-1_54
...
@set QTDOWNLOADPATH=http://download.qt.io/archive/qt/4.8/4.8.5/qt-win-opensource-4.8.5-mingw.exe
...
@set ADDITIONALCCFLAGS=-fno-guess-branch-probability -frandom-seed=2015 -Wno-unused-variable -Wno-unused-value -Wno-sign-compare -Wno-strict-aliasing
