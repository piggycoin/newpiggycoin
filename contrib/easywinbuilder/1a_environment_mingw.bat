...
@pause
%MINGWPATH%\bin\mingw-get update
%MINGWPATH%\bin\mingw-get install msys-base
...
%MINGWPATH%\bin\mingw-get install --reinstall --recursive "gcc=4.8.*"
%MINGWPATH%\bin\mingw-get install --reinstall --recursive "gcc-g++=4.8.*"
%MINGWPATH%\bin\mingw-get install --reinstall --recursive "gcc-bin=4.8.*"

%MINGWPATH%\bin\mingw-get install --reinstall --recursive "libgmp-dll=5.1.2-*"
%MINGWPATH%\bin\mingw-get install --reinstall --recursive "libz"
%MINGWPATH%\bin\mingw-get install --reinstall --recursive "mingwrt-dev"
%MINGWPATH%\bin\mingw-get install --reinstall --recursive "w32api=3.17-2"
%MINGWPATH%\bin\mingw-get install --reinstall --recursive "w32api-dev=3.17-2"
